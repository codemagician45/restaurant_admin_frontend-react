...
const reducer = handleActions({
  ...
  [getRestaurantsSucceed] (state, { payload: { restaurants } }) {
    return {
      ...state,
      loading: false,
      restaurants
  ...
  [getRestaurantsFailed] (state, { payload: { error } }) {
    return {
      ...state,
      error,
      loading: false
  ...
  [addRestaurantFailed](state, { payload: { error } }) {
    return {
      ...state,
      loading: false,
      success: false,
  ...
  [deleteRestaurant](state, { payload: { id } }) {
    return {
      ...state,
      loading: true,
      success: false,
  ...
  [deleteRestaurantFailed](state, { payload: { error } }) {
    return {
      ...state,
      loading: false,
      success: false,
  ...
  [updateRestaurantFailed](state, { payload: { error } }) {
    return {
      ...state,
      loading: false,
      success: false,
  ...
  [getRestaurantSucceed](state, { payload: { restaurant } }) {
    return {
      ...state,
      loading: false,
      message: '',
  ...
  [updateCurrentRestaurant](state, { payload: { restaurant } }) {
    return {
      ...state,
      currentRestaurant: restaurant
    }
