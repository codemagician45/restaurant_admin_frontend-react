...
const reducer = handleActions({
  ...
  [addItemFailed](state, { payload: { error } }) {
    return {
      ...state,
      loading: false,
      success: false,
  ...
  [deleteItemFailed](state, { payload: { error } }) {
    return {
      ...state,
      loading: false,
      success: false,
  ...
  [updateItemFailed](state, { payload: { error } }){
    return {
      ...state,
      loading: false,
      success: false,
  ...
  [getItemSucceed](state, { payload: { item } }) {
    return {
      ...state,
      loading: false,
      message: '',
  ...
  [getItemFailed](state, { payload: { error }}) {
    return {
      ...state,
      loading:false,
      success: false,
  ...
  [updateCurrentItem](state, { payload: { item } }) {
    return {
      ...state,
      currentItem: item
    }
